    ...
    def __init__(self, train_or_valid = "train", transform=None):
        ...
        if train_or_valid == "train":
            ...
            if not loaded: 
                ...
                np.save("/home/ubuntu/project/data/postproc/train_X_smallest2.npy", self.X)
                np.save("/home/ubuntu/project/data/postproc/train_y_smallest2.npy", self.y)
                self.X = np.uint8(self.X * 255)
                
            else:
                self.X = np.load("/home/ubuntu/project/data/postproc/train_X_smallest2.npy")
                self.y = np.load("/home/ubuntu/project/data/postproc/train_y_smallest2.npy")
                self.X = np.uint8(self.X * 255)
